function submitForm() {
    ...
    if (permissao === 0) {
        // Se for coordenador
        alert("Você é um Coordenador! Redirecionando para a área de coordenadores.");
        ...
        // Se for colaborador
        alert("Você é um Colaborador! Redirecionando para a área de colaboradores.");
        // Redireciona para a área de colaboradores
        window.location.href = "/colaboradores/colaborador";  // Coloque o URL correto da área de colaboradores
    } else {
