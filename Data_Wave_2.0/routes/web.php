...
/*              ROTAS USUÁRIOS            */
Route::get('/usuarios', [UsuariosController::class, 'index']) -> name('login');
...
Route::get('colaboradores/colaborador', [ColaboradoresController::class, 'colaborador']);
...
/*              ROTA DA ADMNISTRAÇÃO     */
Route::get('/admnistrativo', [UsuariosController::class,'Adm']);